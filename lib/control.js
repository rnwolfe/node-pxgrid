...
class Control {
  ...
  /**
   * @description
   * Activate your client pxGrid account on the controller. This needs to happen one time before using your new client, as well as anytime its state changes to PENDING or DISABLED on the controller.
   *
