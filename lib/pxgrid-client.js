...
class PxgridRestClient {
  ...
  subscribeToTrustSecPolicyDownloads(stompClient, messageCallback) {
    ...
    .then(service => this._subscribeToTopic(stompClient, service.properties.policyDownloadTopic, messageCallback));
  }
  ...
  subscribeToSecurityGroups(stompClient, messageCallback) {
    ...
    .then(service => this._subscribeToTopic(stompClient, service.properties.securityGroupTopic, messageCallback));
  }
  ...
  subscribeToSxpBindings(stompClient, messageCallback) {
    ...
    .then(service => this._subscribeToTopic(stompClient, service.properties.bindingTopic, messageCallback));
  }
