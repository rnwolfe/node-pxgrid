...
class PxgridControl {
  ...
  _accountActivate(accountDesc = 'pxgrid-node') {
    ...
    return this._post('/control/AccountActivate', payload)
  ...
  serviceLookup(serviceName) {
    ...
    return this._post('/control/ServiceLookup', payload);
  }

  getAccessSecret(nodeName) {
    const payload = { "peerNodeName": nodeName };
    return this._post('/control/AccessSecret', payload);
  }

  getServiceSession(service) {
